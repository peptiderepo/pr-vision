 ...
 *
 * Who triggers: PRV_Probe_Runner for each (model, query) combination.
 * Dependencies: None — pure interface.
 *
 * @see class-prv-perplexity-provider.php  — Perplexity sonar implementation.
 * @see class-prv-openrouter-provider.php  — OpenRouter generic implementation.
 * @see class-prv-probe-runner.php         — Dispatches to providers via this interface.
 * @see CONTEXT.md                         — "provider", "probe".
 * @package PrVision
 */
interface PRV_Probe_Provider {
	 ...
	 * - Detect whether PRV_TARGET_DOMAIN appears in those sources.
